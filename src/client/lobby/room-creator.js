            ...
            <div className="col-lg-4 text-center">
                ...
                <div className="col-lg-12 list-group">
                    <div className={`row ${style.space}`}>
                        ...
                        <button id="user-name-button" className="btn btn-success" onClick={onUsernameClick.bind(this)}>Set Username</button>
                    </div>
                    <br></br>
                    <div className="row">
                        <input id="room-name" type="text" placeholder="Please type new room name"></input>
                        <button id="room-name-button" className="btn btn-success" onClick={onRoomnameClick.bind(this)}>Create Room</button>
                    </div>
                </div>
            </div>
        );
